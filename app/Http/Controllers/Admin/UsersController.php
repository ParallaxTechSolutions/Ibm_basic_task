...
class UsersController extends Controller
{
    ...
    public function index(IndexUser $request)
    {
        ...
        // pass the request with params
            ...
            ['id', 'first_name', 'last_name', 'gender', 'street', 'city', 'state', 'country', 'post_code', 'phone', 'status', 'email'],

            // set columns to searchIn
            ['id', 'first_name', 'last_name', 'gender', 'street', 'city', 'state', 'country', 'post_code', 'phone', 'image', 'email']
        );
